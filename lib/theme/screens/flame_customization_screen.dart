...
class _FlameCustomizationScreenState extends State<FlameCustomizationScreen> {
  ...
  Widget build(BuildContext context) {
    // Determine the selected index based on the current theme color
    final currentThemeColor = Provider.of<ThemeProvider>(context).primaryColor;
    int _selectedIndex = _flameStyles.indexWhere((style) => style['color'] == currentThemeColor);
    if (_selectedIndex == -1) _selectedIndex = 1; // Default fallback to blue focus
