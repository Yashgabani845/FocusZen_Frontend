...
import 'package:focusappfrontend/focus_timer/ui/bottom_navbar.dart';
import 'package:focusappfrontend/focus_timer/ui/stat_card.dart';
...
import 'package:focusappfrontend/focus_timer/screens/analytics_screen.dart';
import 'package:focusappfrontend/focus_timer/screens/flame_progress_screen.dart';
import 'package:focusappfrontend/theme/screens/flame_customization_screen.dart';
import 'package:focusappfrontend/focus_timer/screens/focus_timer_screen.dart';
import 'package:focusappfrontend/app_blocker/screens/app_blocker_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(
          child: LayoutBuilder( // Use LayoutBuilder wrapper to give min-height
            builder: (context, constraints) {
              return SingleChildScrollView(
                child: ConstrainedBox(
                  constraints: BoxConstraints(
                    minHeight: constraints.maxHeight, // Keep minimum height to push things down
                  ),
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24.0, vertical: 16.0),
                    child: IntrinsicHeight( // Allows Spacer like behavior or dynamic sizing
                      child: Column(
                        ...
                        children: [
                          ...
                          const Spacer(), // Spacer works now because of IntrinsicHeight
